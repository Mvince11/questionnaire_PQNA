...
intro <- read_xlsx("data/Gestion_eau.xlsx") %>%
...
<script>window.currentProgressStep = 11;</script>
<script>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Bloc question 33a (syndicat mixte)
  const q33a = document.querySelector('#q33a');
  if (q33a) {
    if (valIntro === "un syndicat mixte") {
      q33a.style.display = "block";
      q33a.classList.add("visible");
    } else {
      q33a.style.display = "none";
      q33a.classList.remove("visible");
    }
  }

  // Bloc question 33 (autres cas)
  const q33 = document.querySelector('#q33');
  if (q33) {
    if (valIntro !== "un syndicat mixte") {
      q33.style.display = "block";
      q33.classList.add("visible");
    } else {
      q33.style.display = "none";
      q33.classList.remove("visible");
    }
  }
});
</script>
...
<button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='nature_en_ville.html';"> < Précédent</button>
...
{{< include _includes/custom_footer.html >}}
 ...
 <button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='littoral.html';"> Suivant > </button>
