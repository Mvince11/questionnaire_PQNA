...
intro <- read_xlsx("data/Territoire_intelligent.xlsx") %>%
...
<script>window.currentProgressStep = 4;</script>
<script>
...
<div style="border: 1px solid #f6f3f3;
   ...
   <div style="color: red; font-size:0.8rem; margin-top: 3px; margin-bottom: 40px; margin-left: 10px;">*Champs obligatoires</div>          
        ...
        <div style="margin-left:4%;
                    ...
                    margin-bottom: 70px;"
                    >
            <h4 style="font-weight: bold;"> Territoire intelligent </h4>
            
            <br>
                    
            <div> Le numérique constitue un levier essentiel pour réussir sa transition écologique. Pour les territoires, l’enjeu ne se limite pas au choix d’innovations technologiques.
Il convient de bâtir un projet associant l’ensemble des parties prenantes en intégrant les priorités politiques et les spécifiques locales.
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Bloc question 12a (syndicat mixte)
  const q12a = document.querySelector('#q12a');
  if (q12a) {
    if (valIntro === "un syndicat mixte") {
      q12a.style.display = "block";
      q12a.classList.add("visible");
    } else {
      q12a.style.display = "none";
      q12a.classList.remove("visible");
    }
  }
  ...
  if (q12) {
    if (valIntro !== "un syndicat mixte") {
      ...
      q12.classList.add("visible");
    } else {
      q12.style.display = "none";
      q12.classList.remove("visible");
    }
  }
});
</script>
...
<button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='amenagement_urbain_durable.html';"> < Précédent</button>
...
{{< include _includes/custom_footer.html >}}
 ...
 <button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='sobriete_fonciere.html';"> Suivant > </button>
