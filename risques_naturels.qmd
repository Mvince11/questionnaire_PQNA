...
intro <- read_xlsx("data/Risques_naturels.xlsx") %>%
...
<script>window.currentProgressStep = 9;</script>
<script>
...
<div style="border: 1px solid #f6f3f3;
   ...
   <div style="color: red; font-size:0.8rem; margin-top: 3px; margin-bottom: 40px; margin-left: 10px;">*Champs obligatoires</div>          
        ...
        <div style="margin-left:4%;
                    ...
                    margin-bottom: 70px;"
                    >
            <h4 style="font-weight: bold;"> Gestion et Prévention des risques naturels </h4>
            
            <br>
                    
            <div> Le changement climatique amplifie l’intensité et la fréquence des phénomènes naturels, engendrant des problématiques majeures de sécurité et une augmentation du coût des dommages induits.
Les gestionnaires territoriaux sont appelés à réduire la vulnérabilité de leur patrimoine, anticiper et mettre en œuvre des stratégies d’aménagement locales pour s’adapter aux risques naturels.
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Bloc question 27a (syndicat mixte)
  const q27a = document.querySelector('#q27a');
  if (q27a) {
    if (valIntro === "un syndicat mixte") {
      q27a.style.display = "block";
      q27a.classList.add("visible");
    } else {
      q27a.style.display = "none";
      q27a.classList.remove("visible");
    }
  }

  // Bloc question 27 (autres cas)
  const q27 = document.querySelector('#q27');
  if (q27) {
    if (valIntro !== "un syndicat mixte") {
      q27.style.display = "block";
      q27.classList.add("visible");
    } else {
      q27.style.display = "none";
      q27.classList.remove("visible");
    }
  }
});
</script>
...
<button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='infrastructures_resilientes.html';"> < Précédent</button>
...
{{< include _includes/custom_footer.html >}}
 ...
 <button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='nature_en_ville.html';"> Suivant > </button>
