...
intro <- read_xlsx("data/Renaturation.xlsx") %>%
...
<script>window.currentProgressStep = 10;</script>
<script>
...
<div style="border: 1px solid #f6f3f3;
   ...
   <div style="color: red; font-size:0.8rem; margin-top: 3px; margin-bottom: 40px; margin-left: 10px;">*Champs obligatoires</div>          
        ...
        <div style="margin-left:4%;
                    ...
                    margin-bottom: 70px;"
                    >
            <h4 style="font-weight: bold;"> Nature en ville </h4>
            
            <br>
                    
            <div> La crise sanitaire et climatique a accéléré la prise de conscience collective : la nature participe largement à l’équilibre de la vie urbaine et devient un facteur d’attractivité incontournable.
Soucieux de la qualité de vie et de la santé de vos concitoyens, vous souhaitez garantir un espace urbain vivable. Vous êtes attachés à la biodiversité, à la résilience de votre territoire, aux solutions douces.
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Bloc question 30a (syndicat mixte)
  const q30a = document.querySelector('#q30a');
  if (q30a) {
    if (valIntro === "un syndicat mixte") {
      q30a.style.display = "block";
      q30a.classList.add("visible");
    } else {
      q30a.style.display = "none";
      q30a.classList.remove("visible");
    }
  }

  // Bloc question 30 (autres cas)
  const q30 = document.querySelector('#q30');
  if (q30) {
    if (valIntro !== "un syndicat mixte") {
      q30.style.display = "block";
      q30.classList.add("visible");
    } else {
      q30.style.display = "none";
      q30.classList.remove("visible");
    }
  }
});
</script>
...
<button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='risques_naturels.html';"> < Précédent</button>
...
{{< include _includes/custom_footer.html >}}
 ...
 <button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='gestion_integree_de_l_eau.html';"> Suivant > </button>
