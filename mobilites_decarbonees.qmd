...
intro <- read_xlsx("data/Mobilites_decarbonees.xlsx") %>%
...
<script>window.currentProgressStep = 7;</script>
<script>
...
<div style="border: 1px solid #f6f3f3;
   ...
   <div style="color: red; font-size:0.8rem; margin-top: 3px; margin-bottom: 40px; margin-left: 10px;">*Champs obligatoires</div>          
        ...
        <div style="margin-left:4%;
            ...
            <div> L’objectif de neutralité carbone à horizon 2050 implique d’importants changements sur l’organisation des systèmes de transports, les usages et comportements, ainsi que les choix technologiques associés. Tous les leviers (report modal, taux de remplissage, efficacité énergétique, sobriété des déplacements) doivent être mobilisés, à la fois pour les voyageurs et les marchandises.
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Bloc question 21a (syndicat mixte)
  const q21a = document.querySelector('#q21a');
  if (q21a) {
    if (valIntro === "un syndicat mixte") {
      q21a.style.display = "block";
      q21a.classList.add("visible");
    } else {
      q21a.style.display = "none";
      q21a.classList.remove("visible");
    }
  }
  ...
  if (q21) {
    if (valIntro !== "un syndicat mixte") {
      ...
      q21.classList.add("visible");
    } else {
      q21.style.display = "none";
      q21.classList.remove("visible");
    }
  }
});
</script>
...
{{< include _includes/custom_footer.html >}}
 ...
 <button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='infrastructures_resilientes.html';"> Suivant > </button>
