...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Bloc question 5a (syndicat mixte)
  const q5a = document.querySelector('#q5a');
  if (q5a) {
    if (valIntro === "un syndicat mixte") {
      q5a.style.display = "block";
      q5a.classList.add("visible");
    } else {
      q5a.style.display = "none";
      q5a.classList.remove("visible");
    }
  }

  // Bloc question 5 (autres cas)
  const q5 = document.querySelector('#q5');
  if (q5) {
    if (valIntro !== "un syndicat mixte") {
      q5.style.display = "block";
      q5.classList.add("visible");
    } else {
      q5.style.display = "none";
      q5.classList.remove("visible");
    }
  }
});
</script>
...
{{< include _includes/custom_footer.html >}}
 ...
 <button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='amenagement_urbain_durable.html';"> Suivant > </button>
