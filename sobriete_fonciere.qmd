...
intro <- read_xlsx("data/sobriete_fonciere.xlsx") %>%
...
<script>window.currentProgressStep = 5;</script>
<script>
...
<div style="border: 1px solid #f6f3f3;
   ...
   <div style="color: red; font-size:0.8rem; margin-top: 3px; margin-bottom: 40px; margin-left: 10px;">*Champs obligatoires</div>          
        ...
        <div style="margin-left:4%;
                    ...
                    margin-bottom: 70px;"
                    >
            <h4 style="font-weight: bold;"> Sobriété foncière </h4>
            
            <br>
                    
            <div> En réaffirmant l’objectif de zéro artificialisation nette à l’horizon 2050 et la diminution de moitié du rythme annuel de consommation foncière d’ici 2031, la loi climat et résilience de 2021 appelle les collectivités à repenser en profondeur les modèles d’aménagement du territoire, pour permettre des modes de vie plus sobres et préserver les sols.
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Bloc question 15a (syndicat mixte)
  const q15a = document.querySelector('#q15a');
  if (q15a) {
    if (valIntro === "un syndicat mixte") {
      q15a.style.display = "block";
      q15a.classList.add("visible");
    } else {
      q15a.style.display = "none";
      q15a.classList.remove("visible");
    }
  }
  ...
  if (q15) {
    if (valIntro !== "un syndicat mixte") {
      ...
      q15.classList.add("visible");
    } else {
      q15.style.display = "none";
      q15.classList.remove("visible");
    }
  }
});
</script>
...
<button style="background-color: #ef7757;
  ...
  font-family: normal;
  border-color: coral;"
  onclick="window.location.href='territoire_intelligent.html';"> < Précédent</button>
